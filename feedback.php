  ...
  <div class="modal-dialog">
    <div class="modal-content title1">
      <div class="modal-header">
        ...
        <h4 class="modal-title title1"><span style="color:orange;border-radius:10px">Log In</span></h4>
      </div>
  ...
  <div class="col-md-6">
    <input id="password" name="password" placeholder="Enter your Password" class="form-control input-md" type="password">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" style="border-radius:10px" class="btn btn-primary">Log in</button>
		</fieldset>
</form>
      </div>
    </div><!-- /.modal-content -->
...
<div class="bg1" style="background-image:url(image/bg.jpg);background-repeat:no-repeat">
<div class="row">
...
<!--Modal for admin login-->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
        <h4 class="modal-title"><span style="color:orange;font-family:'typo';border-radius:10px">LOGIN</span></h4>
      </div>
